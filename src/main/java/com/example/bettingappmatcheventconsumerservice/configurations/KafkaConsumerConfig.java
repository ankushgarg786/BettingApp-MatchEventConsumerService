...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, MatchCreatedEvent> consumerFactory() {
        ...
        config.put(ConsumerConfig.GROUP_ID_CONFIG, "match-event-consumer-group");
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, MatchCreatedEvent> kafkaListenerContainerFactory() {
